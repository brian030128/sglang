        ...
        for req in reqs:
            ...
            if should_output:
                ...
                if not self.spec_algorithm.is_none():
                    ...
                    spec_draft_time.append(req.spec_draft_time)
                    spec_verify_time.append(req.spec_verify_time)
        ...
        if reqs or is_idle_batch:
            ...
            self.send_to_detokenizer.send_output(
                BatchTokenIDOutput(
                    ...
                    spec_draft_time=spec_draft_time,
                    spec_verify_time=spec_verify_time,
